...
public class ActivityServiceManager extends AsyncTask<String, String, String> {
	...
	private List<DoItActivity> activities;

	public List<DoItActivity> getActivities() {
		return activities;
	}

	public void setActivities(List<DoItActivity> activities) {
	 ...
	 */
	public List<DoItActivity> getActivitiesFromJsonFile(String url) {
