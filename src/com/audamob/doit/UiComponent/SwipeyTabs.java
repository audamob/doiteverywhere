...
public class SwipeyTabs extends ViewGroup implements OnPageChangeListener {
	...
	private int mtextColor = 0xff090A0A;
	...
	public void UpdateSlidingType(int position){
		
		switch (position) {
		case 0:
			try {
		
			ActivityBase.slidingMenuBuilderBase.getSlidingMenu().setTouchModeAbove(SlidingMenu.TOUCHMODE_FULLSCREEN);
		...
		default:
			try {
				...
				ActivityBase.slidingMenuBuilderBase.getSlidingMenu().setTouchModeAbove(SlidingMenu.TOUCHMODE_NONE);
